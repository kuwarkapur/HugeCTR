...
# Please remember to run this jupyter notebook in the [merlin-hugectr:22.06](https://ngc.nvidia.com/catalog/containers/nvidia:merlin:merlin-hugectr) docker container.
